    ...
    <div class="bg-primary pt-3 pb-2">
      <div class="nav d-flex text-white jc-around pb-1">
        <div class="nav-item active">
          <router-link vlass="nav-link" tag="div" to="/">首页</router-link>
        </div>
        <div class="nav-item">
          <router-link vlass="nav-link" tag="div" to="/">攻略中心</router-link>
        </div>
        <div class="nav-item">
          <router-link vlass="nav-link" tag="div" to="/">赛事中心</router-link>
        </div>
      </div>
    </div>
