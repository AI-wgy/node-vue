    ...
    <div class="about">
        ...
        <el-form label-width="120px" @submit.native.prevent = "save">
            ...
            <el-form-item label="详情">
                <vue-editor v-model="model.body" uesCustomImageHandler @image-added="handleImageAdded"></vue-editor>
            </el-form-item>
...
export default {
    ...
    methods:{
        ...
        async save(){
            ...
            // console.log('save')
            // this.$http.post('articles', this.model)
